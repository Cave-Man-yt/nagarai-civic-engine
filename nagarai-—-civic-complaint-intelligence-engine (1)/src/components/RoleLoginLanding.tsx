        ...
        {!selectedRole ? (
          <div className="space-y-3 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto pt-1">
                <button
                  type="button"
                  onClick={() => onSelectRole('officer', { name: '', phone: '', department: 'Municipal Operations Division' })}
                ...
                <button
                  type="button"
                  onClick={() => onSelectRole('citizen', { name: '', phone: '' })}
                ...
                >
                  ...
                  <span>👤 Quick Citizen Access</span>
                </button>
              </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="Enter phone or officer badge ID"
